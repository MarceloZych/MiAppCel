export class NavbarSectionComponent {
    ...
    inyectarEstilos() {
        const cssPath = 'app/components/header/navbar_section/navbar_section.component.css'
    ...
    async render(container) {
        const responseHtml = await fetch('./app/components/header/navbar_section/navbar_section.component.html');
